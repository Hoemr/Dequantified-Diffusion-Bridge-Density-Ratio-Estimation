...
def get_dataset(config, uniform_dequantization=False, evaluation=False):
  ...
  if batch_size % torch.cuda.is_available() != 0:   # jax.device_count()
    raise ValueError(f'Batch sizes ({batch_size} must be divided by'
                     f'the number of devices ({torch.cuda.is_available()})')
...
def get_dataset_for_flow(config, uniform_dequantization=False):
  ...
  :return:
  """
  data_dir = '/public/datasets/binzeng/wei/dre-free/'   # '/atlas/u/kechoi/time-score-dre/'
